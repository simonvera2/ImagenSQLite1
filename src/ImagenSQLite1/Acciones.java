...
public class Acciones {
	...
	public static void ConexionH2(final String usuario, final String clave) {
		try {
			...
			JOptionPane.showMessageDialog(null, "NO se puede Conectar a la Base de Datos", "ERROR",
...
//            Logger.getLogger(Acciones.class.getName()).log(Level.SEVERE, null, ex);
			JOptionPane.showMessageDialog(null, "usuario o Contraseña Errada ", "ATENCION",
...
//            Logger.getLogger(Acciones.class.getName()).log(Level.SEVERE, null, ex);
	...
	public static void ConexionSQLite(final String usuario, final String clave) {
		...
		try {
			CON = DriverManager.getConnection(BD_URL + URL + BASEDATOS, usuario, clave); // agregamos el string de
																							// conexion,
...
//            Logger.getLogger(Acciones.class.getName()).log(Level.SEVERE, null, ex);
	...
	public static void Desconectar() {
		try {
			...
			// Logger.getLogger(Acciones.class.getName()).log(Level.SEVERE, null, ex);
			JOptionPane.showMessageDialog(null, "Error al Desconectar de la Base de Datos", "ERROR",
					JOptionPane.ERROR_MESSAGE);
		}
	}
	...
	public static String generateInsertStatement(String tableName, String imageName, String imagePath) {
		...
		String sql = "INSERT INTO " + tableName + " (nombre, archivo, tipo) VALUES ('" + imageName + "', '"
				+ imageDataString + ", 'gif');";
		return sql;
	}
...
//    private final static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(Acciones.class);
	...
	public void imprimir(JDialog parentFrame, String nombre, String titulo, String icono) {
		...
		VentanaImpresion.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
